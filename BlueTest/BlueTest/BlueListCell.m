...
- (void)connectAction {
    if([self.delegate respondsToSelector:@selector(didClickConnect:)]) {
        [self.delegate didClickConnect:self.indexPath];
    }
}
